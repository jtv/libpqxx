...
void test_084()
{
  ...
  PQXX_CHECK_EQUAL(
    pqxx::to_string(R), pqxx::to_string(R2), "Unexpected result at [1]");

  C.get(R);
  R2 = *i2;
  PQXX_CHECK_EQUAL(
    pqxx::to_string(R), pqxx::to_string(R2), "Unexpected result at [2]");
  i2 += 1;
  ...
  PQXX_CHECK_EQUAL(
    pqxx::to_string(R), pqxx::to_string(R2), "Unexpected result at [3]");
