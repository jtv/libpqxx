...
void test_generate_multiple_items(pqxx::test::context &)
{
  ...
  // Reproduce #1235: Under-budgeted conversion of unquoted-safe elements in
  // arrays.
  std::string_view const expected_string{"{1073741823,1789569706,2505397589}"};
  PQXX_CHECK_GREATER_EQUAL(
    pqxx::size_buffer(
      std::vector<unsigned int>{1073741823, 1789569706, 2505397589}),
    std::size(expected_string),
  ...
  PQXX_CHECK_GREATER_EQUAL(
    pqxx::size_buffer(std::vector<unsigned int>{
